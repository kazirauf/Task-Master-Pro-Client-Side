      ...
      .then((result) => {
        ...
        if (user) {
          return toast.success(
            "create the user account is Successfully done.",
            {
              position: "top-center",
            }
          );
        ...
        <div className="min-h-screen flex items-center justify-center bg-orange-100">
          <div className="bg-white w-96 p-8 rounded-lg shadow-lg py-10">
            ...
            <form onSubmit={handleRegister} className="mt-6">
              ...
              <div className="py-3">
                <h1 className="font-bold mb-2 ml-1 text-orange-700">
                  Password
                </h1>
                <input
                  className="w-full px-4 py-2 text-gray-700 bg-gray-200 rounded-full focus:outline-none focus:border-orange-400 focus:bg-white"
              ...
              <button className="w-full mt-4 py-3 px-4 rounded-full bg-gradient-to-r from-orange-300 to-orange-600 text-white text-center font-semibold text-sm focus:outline-none focus:ring-2 focus:ring-orange-400">
                Register
              </button>
            </form>
            <button
